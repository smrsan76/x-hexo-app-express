...
[x-hexo-app-express](https://npmjs.com/package/x-hexo-app-express) package, there:
```bash
...
1.8 - Open the file which you want to use [x-hexo-app-express](https://npmjs.com/package/x-hexo-app-express)
